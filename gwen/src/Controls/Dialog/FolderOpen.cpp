...
void Gwen::Dialogs::FolderOpenEx( bool bUseSystem, const String& Name, const String& StartPath, Gwen::Event::Handler* pHandler, Gwen::Event::Handler::FunctionWithString fnCallback )
{
