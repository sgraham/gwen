...
namespace Gwen 
{
	namespace Dialogs
	{
		...
		//
		void GWEN_EXPORT FolderOpenEx( bool bUseSystem, const String& Name, const String& StartPath, Gwen::Event::Handler* pHandler = NULL, Gwen::Event::Handler::FunctionWithString fnCallback = NULL );
		...
		{
			FolderOpenEx( bUseSystem, Name, StartPath, pHandler, static_cast<Gwen::Event::Handler::FunctionWithString>(fnCallback) );
		}
