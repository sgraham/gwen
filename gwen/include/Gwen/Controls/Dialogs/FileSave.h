...
namespace Gwen 
{
	namespace Dialogs
	{
		...
		//
		void GWEN_EXPORT FileSaveEx( bool bUseSystem, const String& Name, const String& StartPath, const String& Extension, Gwen::Event::Handler* pHandler = NULL, Gwen::Event::Handler::FunctionWithString fnCallback = NULL );
		...
		{
			FileSaveEx( bUseSystem, Name, StartPath, Extension, pHandler, static_cast<Gwen::Event::Handler::FunctionWithString>(fnCallback) );
		}
